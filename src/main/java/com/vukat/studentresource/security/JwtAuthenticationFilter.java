...
import static com.vukat.studentresource.security.SecurityConstants.HEADER_STRING;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private String getJWTFromRequest(HttpServletRequest request){
        ...
        if(StringUtils.hasText(bearerToken) && bearerToken.startsWith(TOKEN_PREFIX)){  // check not blank and starts with 'Bearer '
